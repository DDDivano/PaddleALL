...
本教程使用 horse2zebra 数据集 来进行模型的训练测试工作，可以通过指定 `python download.py --dataset horse2zebra` 下载得到。
...
```
data/horse2zebra/testA/234_A.jpg
data/horse2zebra/testA/292_A.jpg
data/horse2zebra/testA/412_A.jpg
```
